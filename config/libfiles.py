...
srcFiles = [
    ...
    'src/controlplane/flowmanagement/flowhandler/FlowHandlerShortcut.cpp',
    ...
    'src/helper/idprovider/CellId.cpp',
    'src/helper/Keys.cpp',
...
hppFiles = [
    ...
    'src/controlplane/flowmanagement/flowhandler/FlowHandlerShortcut.hpp',
    ...
    'src/helper/idprovider/CellId.hpp',
