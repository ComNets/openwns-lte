...
#ifndef LTE_CONTROLPLANE_RRHANDLERSHORTCUT_HPP
#define LTE_CONTROLPLANE_RRHANDLERSHORTCUT_HPP
...
class RRHandlerShortcut:
    public wns::ldk::ShortcutFU<wns::service::dll::UnicastAddress, RRHandlerShortcut*>,
...
class RRHandlerShortcutUT:
    public RRHandlerShortcut,
    public wns::Cloneable<RRHandlerShortcutUT>
{
public:
...
class RRHandlerShortcutBS:
    public RRHandlerShortcut,
    public wns::Cloneable<RRHandlerShortcutBS>
{
public:
    RRHandlerShortcutBS(wns::ldk::fun::FUN*, const wns::pyconfig::View&);
...
#endif // LTE_CONTROLPLANE_RRHANDLERSHORTCUT_HPP
