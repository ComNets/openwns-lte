...
#ifndef WINPROST_MACR_PHYUSER_HPP
#define WINPROST_MACR_PHYUSER_HPP

#include <LTE/phy/PhyCommand.hpp>
...
class PhyUser :
            public wns::ldk::fu::Plain<PhyUser, PhyCommand>,
...
public:
    ...
    /** @brief for external setting of transmission/reception state by
     * Events from winprost::timing::events */
    /** @todo setTransceiverDirection could be a better name */
    void
    ...
    /** @brief MAC address has to be set externally @see winprost::Layer2::Layer2::onNodeCreated() */
    virtual void
...
#endif // NOT defined LTE_PHY_PHYUSER_HPP
